        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building scalable full-stack applications and cloud-native solutions using
                Java, Golang, React, and AWS. Focused on delivering secure,
                high-performance systems through modern architectures and engineering best practices.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Leveraging Generative AI, Machine Learning, and Retrieval-Augmented
                Generation (RAG) to build intelligent applications that transform data
                into actionable insights and seamless user experiences.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
